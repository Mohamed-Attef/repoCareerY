  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        />
        <Route
          path="/track/:id/skill/:skillId/assessment"
          element={
            <RequireAuth>
              <TrackAssessmentPage />
            </RequireAuth>
        ...
        />
        <Route
          path="/track/:id/showMissingSkills"
          element={
            <RequireAuth>
              <ShowingMissingSkills />
            </RequireAuth>
          }
        />
        <Route
          path="/track/:id/missingSkills"
          element={
            <RequireAuth>
              <MissingSkillsPage />
            </RequireAuth>
